...
const StaticQName QN_USERNAME = { STR_EMPTY, "username" };
const StaticQName QN_PASSWRD = { STR_EMPTY, "password" };
...
// ext dsico
const char NS_EXTDISCO_INFO[] = "urn:xmpp:extdisco:1";
const StaticQName QN_EXTDISCO_SERVICES = { NS_EXTDISCO_INFO, "services" };
const StaticQName QN_EXTDISCO_SERVICE = { STR_EMPTY, "service" };
const StaticQName QN_EXTDISCO_HOST = { STR_EMPTY, "host" };
const StaticQName QN_EXTDISCO_PORT = { STR_EMPTY, "port" };
const StaticQName QN_EXTDISCO_TRANSPORT = { STR_EMPTY, "transport" };
const StaticQName QN_EXTDISCO_TYPE = { STR_EMPTY, "type" };
const StaticQName QN_EXTDISCO_USERNAME = { STR_EMPTY, "username" };
const StaticQName QN_EXTDISCO_PASSWORD = { STR_EMPTY, "password" };
