...
public abstract BareJID getBareJID() throws NotAuthorizedException;
	...
	//linlinno
	public String getDataSimple(BareJID user, String key, String def)
			throws NotAuthorizedException, TigaseDBException {
		System.out.println("getData...");
		String ret = def;
		try {
			ret = repo.getData(user, key);
		} catch (UserNotFoundException e) {
	...
	public Authorization updatePwd(BareJID user,String pwd) throws TigaseDBException{

		try {
			authRepo.updatePassword(user, pwd);
			return Authorization.AUTHORIZED;
		} catch (UserNotFoundException e) {
